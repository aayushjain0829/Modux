...
2. Confirm the exact branch you are on and the target branch for the PR (e.g., `staging` -> `main` or `development` -> `staging`).
...
### Example Workflow
1. The user says "Create a PR from development to staging".
