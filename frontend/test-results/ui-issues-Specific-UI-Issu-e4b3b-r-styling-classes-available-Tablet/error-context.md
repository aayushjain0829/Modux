...
- Name: ui-issues.spec.js >> Specific UI Issue Tests >> Bingo Lobby has correct timer styling classes available
- Location: e2e/ui-issues.spec.js:13:3
...
- generic [ref=e4]:
  - button [ref=e5] [cursor=pointer]:
    - img [ref=e6]
  - heading "Modux" [level=1] [ref=e9]
  - paragraph [ref=e10]: Modular Web Platform
  - button "Play Cross Clue" [ref=e11] [cursor=pointer]
  - button "Play BINGO" [ref=e12] [cursor=pointer]
```
